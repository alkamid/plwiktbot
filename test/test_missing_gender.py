...
def test_missing_gender():
    ...
    assert not test_page.language_sections['jidysz'].pos[0].has_valid_gender()

    # French should have gender but doesn't
    # Polish should have gender and does
    test_page = PagePLWiki(title='hetman', parse=False)
    test_page.text = test_page.getOldVersion(oldit=6758705)
    ...
    test_page.text = test_page.getOldVersion(6354030)
